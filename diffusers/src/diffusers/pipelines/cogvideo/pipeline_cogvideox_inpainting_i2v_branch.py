...
class CogVideoXI2VDualInpaintPipeline(DiffusionPipeline, CogVideoXLoraLoaderMixin):
    r"""
    ...
    def __call__(
        ...
        latents_outputs = self.prepare_latents(
            ...
            return_noise=True,
            return_video_latents=(return_video_latents and not is_strength_max), # anton, to save time
        ) # [B, F, C, H, W]
        
        if (return_video_latents and not is_strength_max): # anton, to save time
        ...
        condition_video = self.video_processor.preprocess_video(condition_video, height=height, width=width)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            ...
            for i, t in enumerate(timesteps):
                ...
                if callback_on_step_end is not None:
                    ...
                    condition_video_latents = callback_outputs.pop("condition_video_latents", condition_video_latents)
