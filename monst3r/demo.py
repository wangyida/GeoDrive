...
# DEBUG
from dust3r.utils.viz_demo import render_colored_pointclouds, render_colored_pointclouds_pytorch3d
# DEBUG
...
def get_3D_model_from_scene(outdir, silent, scene, min_conf_thr=3, as_pointcloud=False, mask_sky=False,
    ...
    # DEBUG: save the pts3d frame by frame, later visualize with cloudcompare
    # import trimesh
    # for i in range(len(pts3d)):
    #     pc = trimesh.PointCloud(pts3d[i].reshape(-1, 3))
    #     pc.export(f'{outdir}/pts3d_frame_{i}.ply')
    ...
    # DEBUG, render images
    pp = scene.get_principal_points().cpu()
    import pdb; pdb.set_trace()
    render_colored_pointclouds(outdir, rgbimg[0], pts3d[0], msk[0], focals, pp, cams2world[0:1])
    render_colored_pointclouds_pytorch3d(outdir, rgbimg[0], pts3d[0], msk[0], focals[0], pp[0], cams2world[0:1])
